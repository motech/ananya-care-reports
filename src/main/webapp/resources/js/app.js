(function () {
    ...
    angular.module('care', ['ngResource', 'ui.bootstrap', 'localization', '$strap.directives']).config(['$routeProvider', '$httpProvider', function($routeProvider, $httpProvider) {
        $routeProvider
            ...
            .when('/forms', { templateUrl: 'resources/partials/forms/listForms.html', controller: 'formListController' })
            .when('/forms/:formId', { templateUrl: 'resources/partials/forms/editForm.html', controller: 'formController' })
            .when('/categories', { templateUrl: 'resources/partials/indicators/listCategories.html', controller: 'categoriesListController'})
            .when('/categories/new', { templateUrl: 'resources/partials/indicators/editCategory.html', controller: 'categoriesController'})
            .when('/categories/:categoryId', { templateUrl: 'resources/partials/indicators/editCategory.html', controller: 'categoriesController'})
