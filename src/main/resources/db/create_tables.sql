...
-- object: dashboard_app.indicator_type | type: TABLE --
CREATE TABLE IF NOT EXISTS dashboard_app.indicator_type(
...
-- object: dashboard_app.indicator_category | type: TABLE --
...
-- object: dashboard_app.level | type: TABLE --
...
-- object: dashboard_app.area | type: TABLE --
...
-- object: dashboard_app.report_type | type: TABLE --
...
-- object: dashboard_app.comparison_symbol | type: TABLE --
...
-- object: dashboard_app.form | type: TABLE --
...
-- object: dashboard_app.operator_type | type: TABLE --
...
-- object: dashboard_app.complex_condition | type: TABLE --
...
-- object: dashboard_app.condition | type: TABLE --
CREATE TABLE IF NOT EXISTS dashboard_app.condition(
    ...
    REFERENCES dashboard_app.complex_condition (complex_condition_id) MATCH FULL
...
-- object: dashboard_app.care_user | type: TABLE --
...
-- object: dashboard_app.permission | type: TABLE --
...
-- object: dashboard_app.role | type: TABLE --
...
-- object: dashboard_app.care_user_role | type: TABLE --
...
-- object: dashboard_app.role_permission | type: TABLE --
...
-- object: dashboard_app.computed_field | type: TABLE --
...
-- object: dashboard_app.indicator | type: TABLE --
CREATE TABLE IF NOT EXISTS dashboard_app.indicator(
	...
	REFERENCES dashboard_app.indicator_type (indicator_type_id) MATCH FULL
	ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE,
...
-- object: dashboard_app.report | type: TABLE --
...
-- object: dashboard_app.dashboard | type: TABLE --
...
CREATE TABLE IF NOT EXISTS dashboard_app.dashboard_user(
    dashboard_id integer NOT NULL,
	user_id integer NOT NULL,
...
-- object: dashboard_app.report_dashboard | type: TABLE --
...
-- object: dashboard_app.indicator_report | type: TABLE --
...
-- object: dashboard_app.indicator_value | type: TABLE --
...
-- object: dashboard_app.indicator_indicator_category | type: TABLE --
...
-- object: dashboard_app.indicator_user | type: TABLE --
CREATE TABLE IF NOT EXISTS dashboard_app.indicator_user(
	indicator_id integer NOT NULL,
	user_id integer NOT NULL,
...
-- object: dashboard_app.field | type: TABLE --
...
-- object: dashboard_app.field_operation | type: TABLE --
CREATE TABLE IF NOT EXISTS dashboard_app.field_operation(
	...
	REFERENCES dashboard_app.field (field_id) MATCH FULL
	ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE,
...
-- object: dashboard_app.complex_condition_field | type: TABLE --
CREATE TABLE IF NOT EXISTS dashboard_app.complex_condition_field(
	complex_condition_id integer NOT NULL,
...
-- CONSTRAINTS --
ALTER TABLE dashboard_app.indicator_category
...
CREATE TABLE IF NOT EXISTS dashboard_app.trend (
...
ALTER TABLE dashboard_app.indicator
    ...
    REFERENCES dashboard_app.trend (trend_id) MATCH FULL
    ON DELETE NO ACTION ON UPDATE NO ACTION NOT DEFERRABLE;